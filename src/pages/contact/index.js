...
class Contact extends React.Component {
  ...
  componentDidMount() {
    //--Mohamed-Ali Daghfouss Portfolio website Google analytics--
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Mohamed-Ali Daghfous</title>
                <link rel="canonical" href="http://motasimfoad.com/contact" />
                <meta name="description" content="Mohamed-Ali Daghfous | Contact - Product Manager | Project Manager | Software Engineer" />
        </Helmet>
